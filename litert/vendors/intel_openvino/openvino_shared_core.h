...
#ifndef THIRD_PARTY_ODML_LITERT_LITERT_RUNTIME_OPENVINO_SHARED_CORE_H_
#define THIRD_PARTY_ODML_LITERT_LITERT_RUNTIME_OPENVINO_SHARED_CORE_H_
...
#endif  // THIRD_PARTY_ODML_LITERT_LITERT_RUNTIME_OPENVINO_SHARED_CORE_H_
